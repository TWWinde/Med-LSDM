...
#model.vqgan_ckpt='/data/private/autoPET/medicaldiffusion_results/results/checkpoints/vq_gan/AutoPET/results/lightning_logs/version_133784/checkpoints/latest_checkpoint.ckpt' \
#model.vqvae_ckpt='/data/private/autoPET/medicaldiffusion_results/results/checkpoints/vq_vae/SemanticMap/results/lightning_logs/version_139795/checkpoints/latest_checkpoint.ckpt' \
...
#python /misc/no_backups/d1502/medicaldiffusion/test/test_ddpm.py model=ddpm dataset=synthrad2023 model.results_folder_postfix='results_synthrad_spade_tanh_segconv_31out' dataset.label_nc=31 \
#model.vqgan_ckpt=0 \
...
#python /misc/no_backups/d1502/medicaldiffusion/test/test_ddpm.py model=ddpm dataset=duke model.results_folder_postfix='results_duke_vq_spade_segconv_8out' dataset.label_nc=3 \
#model.vqgan_ckpt=0 \
